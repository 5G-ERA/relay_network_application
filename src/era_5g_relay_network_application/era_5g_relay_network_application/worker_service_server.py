...
class WorkerServiceServer():
    ...
    def __init__(self, service_name: str, service_type: str, request_queue: Queue, response_queue: Queue, node: Node, **kw):
        """Constructor
    ...
    def callback_service(self, request: Any, response: Any) -> Any:
        """ The callback function for the service server. 
        Puts the request to the request queue and waits for the response.
